...
![ActionContex包含的对象.png](http://moodpo.com/usr/uploads/2014/01/3799365651.png "ActionContex包含的对象.png")
...
OGNL表达式可以以一个特殊的语法开始，从上下中命名一个解析表达式所根据的对象：
    ...
    ![ValueStack是OGNL表达式默认解析对象.png](http://moodpo.com/usr/uploads/2014/01/534142849.png "ValueStack是OGNL表达式默认解析对象.png")
    ...
    **1.字符串和字符串类型的属性**
    ...
    <pre>`nonExistingProperty on the ValueStack = &lt;s:property value=&quot;nonExistingProperty&quot; /&gt;
    ...
    **2.强制使用OGNL解析**
    ...
    <pre>`nonExistingProperty on the ValueStack =&lt;s:property value=&quot;nonExistingProperty&quot; default=&quot;%{myDefaultString}&quot; /&gt;
